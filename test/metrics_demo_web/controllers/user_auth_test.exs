defmodule MetricsDemoWeb.UserAuthTest do
  use MetricsDemoWeb.ConnCase, async: true

  alias MetricsDemo.Accounts
  alias MetricsDemoWeb.UserAuth
  import MetricsDemo.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, MetricsDemoWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      MetricsDemoWeb.Endpoint.subscribe(live_socket_id)
