defmodule MetricsDemo.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, MetricsDemo.Repo)
  ...
  """
  def valid_password?(%MetricsDemo.Accounts.User{hashed_password: hashed_password}, password)
